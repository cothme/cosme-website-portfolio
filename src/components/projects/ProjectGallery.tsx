...
const ProjectGallery = () => {
	...
	return (
		<div className="w-full bg-opacity-20 backdrop-blur-3xl">
			<div className="flex flex-col lg:flex-row justify-center space-x-6 w-full p-12">
				<div className="flex flex-col items-center">
					<img
						src={images[currentIndex]}
						alt="Gallery"
						className="rounded-lg object-contain border-2 lg:w-[800px] lg:h-[400px] border-extra"
					/>
			...
			<div className="flex w-full gap-2 justify-between lg:justify-evenly p-6">
				...
				/>
				<AnimatedNextButton interact={() => handleProjectNavigation("next")} />
			</div>
		</div>
	);
};
